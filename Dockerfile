# ZEBL_AMS — production image for ECS Fargate / App Runner
...
# Placeholder satisfies prebuild env check; real DATABASE_URL injected at runtime.
ENV DATABASE_URL=postgresql://build:build@127.0.0.1:5432/zebl_ams_build?schema=public
ENV AUTH_SECRET=build-placeholder-not-for-production
RUN npm run build
